...
{
	_progressBarBack->render(getMemDC(), _rcProgress.left - 26, _y - 10, 0, 0, _progressBarBack->getWidth(), _progressBarBack->getHeight());

	_progressBarFront->render(getMemDC(),_rcProgress.left - 26, _y - 10, 0, 0, _width, _progressBarBack->getHeight());

}
void progressBar::render(int x, int y)
{
	_progressBarBack->render(getMemDC(), _rcProgress.left - 26 + x, _y - 10 + y, 0, 0, _progressBarBack->getWidth(), _progressBarBack->getHeight());

	_progressBarFront->render(getMemDC(), _rcProgress.left - 26 + x, _y - 10 + y, 0, 0, _width, _progressBarBack->getHeight());
}
